...
CREATE TRIGGER discount_summary_notify_update AFTER INSERT ON discount_summary FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
CREATE TRIGGER discount_summary_notify_insert AFTER INSERT ON discount_summary FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
...
CREATE TRIGGER engagement_summary_notify_insert AFTER DELETE ON engagement_summary FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
CREATE TRIGGER engagement_summary_notify_update AFTER DELETE ON engagement_summary FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
...
DROP TRIGGER failed_jobs_notify_update ON failed_jobs;
CREATE TRIGGER failed_jobs_notify_insert AFTER UPDATE ON failed_jobs FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
...
CREATE TRIGGER feature_addons_notify_update AFTER INSERT ON feature_addons FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
CREATE TRIGGER feature_addons_notify_insert AFTER INSERT ON feature_addons FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
...
CREATE TRIGGER feedback_call_notify_insert AFTER DELETE ON feedback_call FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
CREATE TRIGGER feedback_call_notify_update AFTER DELETE ON feedback_call FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
...
CREATE TRIGGER invoices_notify_update AFTER INSERT ON invoices FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
CREATE TRIGGER invoices_notify_insert AFTER INSERT ON invoices FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
...
CREATE TRIGGER membership_history_notify_insert AFTER DELETE ON membership_history FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
CREATE TRIGGER membership_history_notify_update AFTER DELETE ON membership_history FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
...
DROP TRIGGER messages_notify_update ON messages;
CREATE TRIGGER messages_notify_insert AFTER UPDATE ON messages FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
...
CREATE TRIGGER monthly_rgcheck_notify_update AFTER INSERT ON monthly_rgcheck FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
CREATE TRIGGER monthly_rgcheck_notify_insert AFTER INSERT ON monthly_rgcheck FOR EACH ROW EXECUTE PROCEDURE table_update_notify();

DROP TRIGGER otp_notify_insert ON otp;
DROP TRIGGER otp_notify_update ON otp;
DROP TRIGGER otp_notify_delete ON otp;
CREATE TRIGGER otp_notify_insert AFTER DELETE ON otp FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
CREATE TRIGGER otp_notify_update AFTER DELETE ON otp FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
...
CREATE TRIGGER partnership_sms_notify_insert AFTER DELETE ON partnership_sms FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
CREATE TRIGGER partnership_sms_notify_update AFTER DELETE ON partnership_sms FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
...
DROP TRIGGER partnerships_notify_update ON partnerships;
CREATE TRIGGER partnerships_notify_insert AFTER UPDATE ON partnerships FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
...
CREATE TRIGGER payment_methods_notify_update AFTER INSERT ON payment_methods FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
CREATE TRIGGER payment_methods_notify_insert AFTER INSERT ON payment_methods FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
...
CREATE TRIGGER profiles_notify_insert AFTER DELETE ON profiles FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
CREATE TRIGGER profiles_notify_update AFTER DELETE ON profiles FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
...
CREATE TRIGGER registration_summary_notify_insert AFTER DELETE ON registration_summary FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
CREATE TRIGGER registration_summary_notify_update AFTER DELETE ON registration_summary FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
...
CREATE TRIGGER retailer_invites_notify_insert AFTER DELETE ON retailer_invites FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
CREATE TRIGGER retailer_invites_notify_update AFTER DELETE ON retailer_invites FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
...
DROP TRIGGER transactions_notify_update ON transactions;
CREATE TRIGGER transactions_notify_insert AFTER UPDATE ON transactions FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
...
CREATE TRIGGER sms_log_notify_update AFTER INSERT ON sms_log FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
CREATE TRIGGER sms_log_notify_insert AFTER INSERT ON sms_log FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
...
CREATE TRIGGER subscription_history_notify_insert AFTER DELETE ON subscription_history FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
CREATE TRIGGER subscription_history_notify_update AFTER DELETE ON subscription_history FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
...
CREATE TRIGGER th_internal_members_notify_insert AFTER DELETE ON th_internal_members FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
CREATE TRIGGER th_internal_members_notify_update AFTER DELETE ON th_internal_members FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
...
DROP TRIGGER tonic_plus_history_notify_update ON tonic_plus_history;
CREATE TRIGGER tonic_plus_history_notify_insert AFTER UPDATE ON tonic_plus_history FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
...
CREATE TRIGGER usage_logs_notify_update AFTER INSERT ON usage_logs FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
CREATE TRIGGER usage_logs_notify_insert AFTER INSERT ON usage_logs FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
...
CREATE TRIGGER whitelist_notify_insert AFTER DELETE ON whitelist FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
CREATE TRIGGER whitelist_notify_update AFTER DELETE ON whitelist FOR EACH ROW EXECUTE PROCEDURE table_update_notify();
